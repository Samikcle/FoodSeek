...
class LayoutController {
  ...
  @FXML
  private var FoodBankMenu: Pane = _

  @FXML
  private var GiveawayMenu: Pane = _

  @FXML
  private var DiscountMenu: Pane = _

  @FXML
  private var ActivitiesMenu: Pane = _

  @FXML
  private var ManageMenu: Pane = _

  @FXML
  private var RequestMenu: Pane = _

  @FXML
  private var Profile: Pane = _
  ...
  def initialize(): Unit = {
    ...
    ActivitiesMenu.setOnMouseClicked(_ => loadPage(ActivitiesMenu, "/view/Activities.fxml"))
  ...
  def loadPage(menu: Pane, fxmlPath: String): Unit = {
    if (currentMenu != null) {
